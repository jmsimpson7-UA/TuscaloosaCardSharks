...
function handleAddForm() {
    let html = `
      <h2 class="section-heading">Add New Inventory Item</h2>
    <form id="addItemForm" onsubmit="return false" class="add-form">
        ...
        <input type="text" id="item-team" placeholder="Enter team name" required />
 
        <label for="item-sport">Sport:</label>
        <input type="text" id="item-sport" placeholder="Enter sport" required />
 
        <label for="item-status">Status:</label>
        <input type="text" id="item-status" placeholder="Enter status" required />
 
        <label for="item-size">Size:</label>
        <input type="text" id="item-size" placeholder="Enter size" required />
 
        <label for="item-price">Price:</label>
        <input type="number" id="item-price" placeholder="Enter price" step="0.01" required />
 
        <label for="item-category">Category:</label>
        <input type="text" id="item-category" placeholder="Enter category" required />
 
        <label for="item-quantity">Quantity:</label>
        <input type="number" id="item-quantity" placeholder="Enter quantity" required />
 
        <button type="button" id="addInventoryButton" class="btn btn-success">Add Item</button>
        <button onclick="handleOnLoad()" class="btn btn-secondary">Cancel</button>
    </form>`;
    document.getElementById("inventoryTable").innerHTML = html;
}
